// =========================================================================
// |ZOMBIFIER v1.0 | for Minecraft v1.12
// | by Kraken | Link TBA
...
// | Source code: https://github.com/randallarms/zombifier
// =========================================================================
...
public class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
		...
		//Copies the default config.yml from within the .jar if "plugins/Zombifier/config.yml" does not exist
	...
	public void loadMessageFiles() {
		...
		for (String lang : languages) {
		    ...
		    File msgFile = new File("plugins/Zombifier/lang/", lang.toLowerCase() + ".yml");
